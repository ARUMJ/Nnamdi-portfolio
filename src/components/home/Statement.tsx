    ...
    >
      <div className="container-page grid gap-8 py-14 sm:py-16 md:grid-cols-2 md:items-center md:gap-12 md:py-20">
        <div className="reveal">
          ...
          <h2
            id="approach-heading"
            className="mt-5 max-w-md font-display text-3xl font-medium leading-[1.12] tracking-tight text-balance text-ink sm:text-4xl"
          >
            Technology that <span className="italic text-accent">works for you</span>.
          </h2>
        </div>
        <div className="reveal max-w-xl border-t border-line pt-6 md:border-l md:border-t-0 md:pl-8 md:pt-0">
